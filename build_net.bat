...
netconvert --node-files cruce2.nod.xml --edge-files cruce2.edg.xml --connection-files cruce2.con.xml --output-file cruce2.net.xml --no-turnarounds --tls.green.time 25 --tls.left-green.time 10
