...
\begin{itemize}
    ...
    \item Disminución de la longitud promedio de colas en \textbf{≥20\%}.
    \item Incremento del \textit{throughput} en \textbf{≥10\%}.
    \item Reducción de emisiones (CO\textsubscript{2}) en \textbf{≥5\%} (estimación SUMO).
\end{itemize}
