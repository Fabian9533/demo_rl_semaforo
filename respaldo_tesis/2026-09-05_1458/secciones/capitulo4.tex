...
\paragraph{U1: Preprocesamiento} comprende todas las tareas
...
\paragraph{U2: Entrenamiento} toma como entrada el escenario de
...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{NETEDIT.PNG}
    \caption{Vista inicial en \texttt{netedit} con la intersección
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{conexiones.PNG}
    \caption{Misma intersección tras la limpieza: calles irrelevantes
    eliminadas y sentidos de los carriles corregidos.}
  \end{subfigure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{OSM.PNG}
    \caption{Selección del \textit{bounding box} en OSM mediante el
    asistente \emph{osmWebWizard}.}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{SUMO.PNG}
    \caption{Red del cruce generada automáticamente en \emph{sumo-gui}.}
  \end{subfigure}
